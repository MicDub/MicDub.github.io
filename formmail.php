...
$recipient = "info2@dubbeldam.com"; // youremail@domain.com
...
// reside on.
$referers = array ('dubbeldam.com','www.dubbeldam.com');
...
function print_error($reason,$type = 0) {
   ...
   echo "<br><br>\n";
   echo "<small>This form is powered by <a href=\"http://www.gig-a-net.com/\">Formmail.php ".VERSION."</a></small>\n\n";
   exit;
}
